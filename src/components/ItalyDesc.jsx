...
export function ItalyDesc(props) {
    ...
    return <div>
        ...
        <p className="flow-text"><img src={FerrariImage} alt='Ferrari' width="300" height="200" align='left'/>Ита́лия (итал. Italia [iˈtaːlja]), официальное название — Италья́нская Респу́блика (итал. Repubblica Italiana [reˈpubːlika itaˈljaːna]) — государство в Южной Европе, в центре Средиземноморья. Входит в Евросоюз и НАТО с момента их создания, является третьей по величине экономикой еврозоны.

Граничит с Францией на северо-западе (протяжённость границы — 488 км), Швейцарией (740 км) и Австрией (430 км) — на севере, Словенией — на северо-востоке (232 км).<img src={Colliseum} alt='Ferrari' width="300" height="200" align='right'/>
...
<button className="btn waves-effect waves-light buttons-main" onClick={() => setDescription('main')}>На главную страницу</button>
    </div>
